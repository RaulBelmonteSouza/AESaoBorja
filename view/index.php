	...
	<main><!--Início do conteúdo principal da página-->
            ...
            <div class="container-fluid my-0 p-0">
                ...
                <div class="row m-0 resultados">
                    ...
                    <div class="col-12 col-md-2 col-lg-2 d-flex p-0">
                        ...
                        <div class="botoes-painel-resultados align-self-center m-auto">
                            ...
                            <a href="https://socio.aesaoborja.com.br/" target="_blank">
                ...
                <div class="row m-0">
                    ...
                    <img class="col-12 p-0 m-0" alt="" src="img/artesocionew.png">

                    <div class="col-12 m-0 p-0 py-4 btn-socio text-center">
                        <a href="https://socio.aesaoborja.com.br/" class="botao-socio-2 text-uppercase my-5 py-3 px-5 font-weight-bold">Seja sócio <i class="fas fa-users"></i></a>
                    </div>
                </div>
