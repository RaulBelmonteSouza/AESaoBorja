<?php
    ...
    include_once "../PHPMailer/PHPMailer-master/src/Exception.php";
    /**
     * Created by PhpStorm.
     * User: Raul
     * Date: 05/10/2018
    ...
    if (!empty($_POST['acao']) and $_POST['acao'] == 1){
        ...
        if ($contato->insert()){
            ...
            $mailer->isSMTP();
            $mailer->Host="http://aesaoborja.net/";
            $mailer->SMTPAuth = true;
            $mailer->Username = "contato@aesaoborja.net";
            $mailer->Password = "aesaobor2020";
            $mailer->SMTPSecure = 'ssl';
            $mailer->Port = 465;
            $mailer->FromName = $contato->getNome();
            $mailer->From = "contato@aesaoborja.net";
